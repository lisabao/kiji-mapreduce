...
import org.kiji.mapreduce.output.KijiTableMapReduceJobOutput.RowOptions;
...
public final class MapReduceJobOutputs {
  ...
  /**
   * Createss a new uninitialized HFileMapReduceJobOutput.
  ...
  /**
   * Creates a new uninitialized KijiTableMapReduceJobOutput.
   * @return a new uninitialized KijiTableMapReduceJobOutput.
   */
  public static KijiTableMapReduceJobOutput newKijiTableMapReduceJobOutput() {
    return new KijiTableMapReduceJobOutput();
  }

  /**
   * Creates a new KijiTableMapReduceJobOutput.
   * @param tableURI The kiji table to write output to.
   * @param numReduceTasks The number of reduce tasks to use (use zero if using a producer).
   * @return a new KijiTableMapReduceJobOutput initialized with the output kiji table and 
   * number of reduce tasks.
   */
  public static KijiTableMapReduceJobOutput newKijiTableMapReduceJobOutput(
      KijiURI tableURI, int numReduceTasks) {
    return new KijiTableMapReduceJobOutput(tableURI, numReduceTasks);
  }
